...
class CalculateExpressCost implements ShippingCostCalculator
{
    private const BASE_PRICE = 50000;
    private const PRICE_PER_KG = 15000;
    private const EXTRA_PERCENTAGE = 20;
    private const INSURANCE_PERCENTAGE = 0.5;

    private const SPECIAL_CITY = CityName::Mashhad;
    private const INSURANCE_LIMIT = 3000000;
    ...
    {
        return $method === MethodName::Express;
    }

    /**
     * Calculate shipping cost breakdown for the given order (Express method).
     *
    ...
    /**
     * Calculate extra cost for orders to the special city (Mashhad).
     *
    ...
    {
        $extraCost = 0;
        if ($order->city === self::SPECIAL_CITY && self::EXTRA_PERCENTAGE > 0) {
